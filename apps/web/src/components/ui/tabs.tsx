...
>(({ className, variant = 'pill', ...props }, ref) => (
  <TabsPrimitive.List
    ...
    className={cn(
      ...
      variant === 'pill' && 'h-9 justify-center gap-1 rounded-lg bg-muted p-1',
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all',
